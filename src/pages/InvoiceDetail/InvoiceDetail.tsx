    ...
    const pdfDocument = (
        <Document>
            <Page style={styles.body}>
                ...
                <Text style={styles.text}>
                    Observation: {invoiceDetail.invoice.observation}
                </Text>
                {/*<Text style={styles.text}>*/}
                {/*    Created At:{' '}*/}
                {/*    {format(*/}
                ...
                {invoiceDetail.plates.map((p: any) => (
                    <>
                        ...
                        <Text style={styles.textItem}>Price: S/{p.price}</Text>
                        <Text style={styles.textItem}>
                            total: S/{p.price * findPlateCount(p.id)}
                        </Text>
                    </>
                ))}
        ...
        <Layout>
            <div className="invoiceDetail">
                ...
                <div className="boxArea">
                    ...
                    <div>Observation: {invoiceDetail.invoice.observation}</div>
                    <div>
                        Date:{' '}
